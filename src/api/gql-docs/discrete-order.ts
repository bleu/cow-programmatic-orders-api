...
export const discreteOrderDocs: DocMap = {
  ...
  "discreteOrder.updatedAtBlock":
    "Indexer block where this order was inserted or its status or executed amounts were last observed to change. Decimal string (BigInt scalar). Use updatedAtBlock_gte for incremental reads.",
