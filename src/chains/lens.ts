...
export const lens: ChainConfig = {
  ...
  orderbookApiUrl: "https://api.cow.fi/lens", // TODO: Lens is NOT in cow-sdk ORDER_BOOK_PROD_CONFIG yet; api.cow.fi/lens returns 404 — verify when CoW Protocol adds Lens orderbook support
};
